...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SerialController Demo Installer\n"
      else:
        line="OutputBaseFilename=SerialController Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SerialController Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SerialController installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SerialController Demo installer\n"
     else:
       line="SetupWindowTitle=SerialController installer\n"
