...
def main():
  ...
  plistpath = scriptpath + "/resources/SerialController-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SerialController-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SerialController-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SerialController-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SerialController-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SerialController.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SerialController.iss",inplace=1):
